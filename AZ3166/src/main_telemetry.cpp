...
static const char *die[] = { die1, die2, die3, die4, die5, die6 };
...
void telemetryLoop() {
    ...
    // process desired property change to get echoed back as a reported property
    echoDesiredProperty();
